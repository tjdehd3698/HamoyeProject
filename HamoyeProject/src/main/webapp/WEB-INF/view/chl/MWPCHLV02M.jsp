			...
			<br><br>
 			<div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="http://www.happybnk.co.kr/upload/141/2848/%EB%A6%AC%ED%94%8C(Re%20Plastic)%EC%BA%A0%ED%8E%98%EC%9D%B81.jpg">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="http://www.happybnk.co.kr/upload/141/2362/%ED%99%98%EA%B2%BD%EC%A0%95%ED%99%94%ED%99%9C%EB%8F%99%20%EC%82%AC%EC%A7%842.jpg">
                        </div>
                        <div class="team-text bg-light text-center p-4">
                            <h5>환경정화 운동</h5>
                            <div class="team-social text-center">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="http://www.happybnk.co.kr/upload/141/1736/20160420_%EA%B8%B4%EA%B8%89%EC%9E%AC%EB%82%9C%EA%B5%AC%ED%98%B8%EB%B4%89%EC%82%AC%ED%99%9C%EB%8F%99%20%EC%8B%A4%EC%8B%9C.jpg">
                        </div>
                        <div class="team-text bg-light text-center p-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="http://www.happybnk.co.kr/upload/141/407/2014.12.13%20%EB%82%99%EB%8F%99%EA%B0%95%ED%95%98%EA%B5%AC%20%EA%B2%A8%EC%9A%B8%EC%B2%A0%EC%83%88%20%EB%A8%B9%EC%9D%B4%EC%A3%BC%EA%B8%B0%20%EB%B0%8F%20%ED%99%98%EA%B2%BD%EC%A0%95%ED%99%94.jpg">
                        </div>
                        <div class="team-text bg-light text-center p-4">
                            <h5>겨울철새 먹이주기</h5>
                            <div class="team-social text-center">
				...
				<h3>지구를 지키는 당신에게 <br>매년 0.5%의 이자를 더 드려요</h3><br>
			 	<c:choose>
					<c:when test="${!empty userName}">
             		...
             		<c:otherwise>
             			<a class="btn btn-outline-primary px-3" data-bs-toggle="modal" data-bs-target="#loginModal">
                               	로그인하고 챌린지 참여하기
             			<div class="d-inline-flex btn-sm-square bg-primary text-white rounded-circle ms-2">
             				<i class="fa fa-arrow-right"></i>
            		 	</div>
